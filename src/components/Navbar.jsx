                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <a
                            ...
                            className="text-xl font-bold bg-gradient-to-r from-[#A8C9A3] to-[#5B9AA0] bg-clip-text text-transparent"
                        >
                            Mgrdegh
                        </a>
                    </div>
                                ...
                                >
                                    <span
                                        className={`relative z-10 transition-colors duration-300 ${activeSection === item.href.substring(1)
                                            ? "bg-gradient-to-r from-[#5B9AA0] to-[#A8C9A3] bg-clip-text text-transparent font-semibold"
                                    ...
                                    <span
                                        className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#5B9AA0] to-[#A8C9A3] transform origin-left transition-transform duration-300 ${activeSection === item.href.substring(1)
                                            ? "scale-x-100"
